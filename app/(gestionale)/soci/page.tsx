import { getSoci } from '@/lib/data';
import { getSupabaseServerClient } from '@/lib/supabase-server';
import { SociPageClient } from '@/components/soci/SociPageClient';
...
export default async function SociPage() {
  ...
  return <SociPageClient initialSoci={soci} organizzazione={organizzazione ?? undefined} />;
}